...
export function getAdminLoginEmail() {
  const emailEnv =
    process.env.NEXT_PUBLIC_ADMIN_LOGIN_EMAIL || "admin@example.com";
  // Support comma-separated emails for multiple admins
  return emailEnv
    .split(",")
...
export function generateOtp() {
  ...
  // console.log(otp); // For development/testing purposes only. Remove in production.
  return otp;
}
